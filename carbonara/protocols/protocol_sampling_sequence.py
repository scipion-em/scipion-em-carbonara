...
# -------------------------- DEFINE param functions ----------------------
    def _defineParams(self, form):
        ...
        form.addParam('chainOptions', params.EnumParam, 
                      choices=['Exclude chains', 'Select one chain'],
                      default=0,
                      expertLevel=LEVEL_ADVANCED, allowsNull=False,
                      label='Chain Options:',
                      help='Select ...')
        # Voy a considerar que cuando excluyes cadenas sólo te quedas con una, estas opciones más complejas para la próxima...
        form.addParam('selectStructureChains', params.EnumParam, 
                      expertLevel=LEVEL_ADVANCED, 
                      choices=[], allowsNull=True, 
                      condition='chainOptions == 0',
